...
def get_video_url( page_url , premium = False , user="" , password="" , video_password="" ):
    logger.info("seriesly.tunepk get_video_url(page_url='%s')" % page_url)
    ...
    for video_url in video_urls:
        logger.info("seriesly.tunepk %s - %s" % (video_url[0],video_url[1]))
...
def find_videos(text):
    ...
    logger.info("seriesly.tunepk find_videos #"+patronvideos+"#")
