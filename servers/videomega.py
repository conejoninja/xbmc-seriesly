...
def test_video_exists( page_url ):
    logger.info("seriesly.videomega test_video_exists(page_url='%s')" % page_url)
    
    return True,""

def get_video_url( page_url , premium = False , user="" , password="", video_password="" ):
    logger.info("seriesly.videomega get_video_url(page_url='%s')" % page_url)
    ...
    logger.info("seriesly.videomega location="+location)
    ...
    for video_url in video_urls:
        logger.info("seriesly.videomega %s - %s" % (video_url[0],video_url[1]))
...
def find_videos(data):
    ...
    logger.info("seriesly.videomega find_videos #"+patronvideos+"#")
