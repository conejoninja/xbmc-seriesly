...
def test_video_exists( page_url ):
    logger.info("seriesly.powvideo test_video_exists(page_url='%s')" % page_url)
    
    return True,""

def get_video_url( page_url , premium = False , user="" , password="", video_password="" ):
    logger.info("seriesly.powvideo get_video_url(page_url='%s')" % page_url)
    ...
    # Extrae la URL
    #file: "http://85.12.5.221:8777/pmohpe5vniikkfn2manpynikhm2adypqnsmgx24skegttzannmwisfjppm/v.flv"
    logger.info("data="+data)
...
def find_videos(data):
    ...
    logger.info("seriesly.powvideo find_videos #"+patronvideos+"#")
