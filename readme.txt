...
* AnimeID
	...
	* Descarga Cine Cl�sico (thanks to ermanitu)
...
seriesly is an XBMC plugin, not an script. It has been tested and works on XBMC, Boxee and Plex.
...
After installation go to XBMC, section "Video / Video Plugins" and you will see the seriesly icon.
...
My spanish blog about "Televisi�n a la carta"
...
Code for extraction URL of video from Megavideo is from Voinage.
It is placed in his tutorial for plugin development for XBMC.
...
ErManitu added the channels "Divxonline" and "Descarga Cine Cl�sico"
...
Messi86 from the telebision.com forum made the DocumentalesYonkis plugin, which i converted to a seriesly channel.
