...
def do_search_results(tecleado):
    ...
    from seriesly.channels import bajui
    itemlist.extend( bajui.search( Item() , tecleado) )

    from seriesly.channels import cineblog01
    itemlist.extend( cineblog01.search( Item() , tecleado) )

    from seriesly.channels import cinetube
    itemlist.extend( cinetube.search( Item() , tecleado, "F") )

    from seriesly.channels import cineonlineeu
    ...
    from seriesly.channels import serieonline
    itemlist.extend( serieonline.search( Item() , tecleado) )

    #from seriesly.channels import seriesid
    ...
    #from seriesly.channels import seriesdanko
...
def por_teclado(params,url="",category=""):
    ...
    if category == "" or category == "Buscador_Generico":
        ...
        if params.plot:
            channel = params.plot
            exec "import seriesly.channels."+channel+" as plugin"
        else:
            exec "import seriesly."+channel+" as plugin"
