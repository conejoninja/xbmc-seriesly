...
if thumbnail_type=="0":
    IMAGES_PATH = 'http://seriesly.mimediacenter.info/posters/'
elif thumbnail_type=="1":
    IMAGES_PATH = 'http://seriesly.mimediacenter.info/banners/'
elif thumbnail_type=="2":
    IMAGES_PATH = 'http://seriesly.mimediacenter.info/squares/'
